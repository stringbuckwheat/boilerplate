...
public class OAuth2MemberService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new UserPrincipal(user.getId(), user.getUsername(), oAuth2Attribute.getAttributes());
    }

    public User saveOrUpdate(OAuth2Attribute oAuth2Attribute){
        User user = userRepository.findByEmailAndProvider(oAuth2Attribute.getEmail(), oAuth2Attribute.getProvider())
